...
This ledger and the linked rev tokens are a critical part of Quorum1’s financial infrastructure. More details are outlined in the [Investment](#investment) section.

The ledger allocation model & rev point plan are part of the Financial Operations Plan, but all other parts of the ledger design are defined in the governance repo, as outlined here: [Org Investment Ledger](./glossary.md#org-investment-ledger).
